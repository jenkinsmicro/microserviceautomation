...
public class TestClass2 extends TestBase {
  ...
  @Test(priority = 1, groups = { "sanity" })
	...
	public void verifyAdminDeletion() throws InterruptedException {
		...
		WebElement element = driver.findElement(By.xpath("(//div[@class='pagination']//a)[last()]"));
		int s = Integer.parseInt(element.getText().trim());

		Reporter.log("No fo pages are :" + s);
		outerloop: for (int i = 1; i <= s; i++) {
			...
			WebElement paginationElement = driver.findElement(By.xpath(
					"(.//*[@id='app']/section/div[2]/div[2]/div/div/div/div/div[3]/div[2]/div/div/ul/li/a)[contains(text(),'"
							+ (i + 1) + "')]"));
